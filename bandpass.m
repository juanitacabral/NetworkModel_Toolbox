...
% Function to filter a signal in a given frequency range.
% Only the components in that frequency range are retained in x
% Everything in y outside that frequency range is discarded.
% 
% Used in Cabral, Luckhoo, Woolrich, ..., Deco (2014)
%
% function x=bandpass(y,[lp hp],1/dt,0))
%
